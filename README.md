...
```
dfx canister call opend_backend listItem '(principal "qoctq-giaaa-aaaaa-aaaea-cai", 2)'
```
...
```
dfx canister call qoctq-giaaa-aaaaa-aaaea-cai transferOwnership '(principal "ryjl3-tyaaa-aaaaa-aaaba-cai", true)'
```
